...
namespace ICE_API
{
    public class Startup
    {
        ...
        {
            var server = Configuration["DBServer"] ?? "192.168.99.100,1433";
            ...
            services.AddDbContext<DataContext>(opt => opt.UseSqlServer($"Server={server}; Initial Catalog={database};User ID={user};Password={password}"));
